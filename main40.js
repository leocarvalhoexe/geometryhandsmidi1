// ==========================================================================
// MIDI SHAPE MANIPULATOR v40 - main40.js
// ==========================================================================
...
function setupEventListeners() {
    ...
    if (sidebar && sidebarHandle) {
        ...
        // REMOVED: Desktop hover behavior and old mobile touch behavior
        ...
        // Consider touchstart for mobile as well, though click might cover it.
        // Using a single 'click' listener on document might be sufficient for both desktop and mobile for closing.
        // The original touchstart logic for closing was a bit complex; simplifying here.
        // If specific touch handling for closing is still needed, it can be added back carefully.
    }
...
window.addEventListener('DOMContentLoaded', () => {
    console.log("DOM Carregado. Iniciando main40.js..."); // Updated version in log
    ...
    console.log("main40.js inicialização completa."); // Updated version in log
});
// === END INITIALIZATION ===
