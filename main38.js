// ==========================================================================
// MIDI SHAPE MANIPULATOR v38 - main38.js
// ==========================================================================
    ...
    if (sidebar && sidebarHandle) {
        ...
        if (!isTouchDevice) { // Desktop hover behavior
            sidebarHandle.addEventListener('mouseenter', () => {
                ...
                document.documentElement.style.setProperty('--sidebar-open-factor', '1');
            });
            ...
            sidebarHandle.addEventListener('click', (event) => {
                ...
                if (isOpen) {
                    document.documentElement.style.setProperty('--sidebar-width', '250px'); // Assuming mobile sidebar width is also 250px
                    document.documentElement.style.setProperty('--sidebar-open-factor', '1');
                } else {
                    document.documentElement.style.setProperty('--sidebar-open-factor', '0');
                }
...
window.addEventListener('DOMContentLoaded', () => {
    console.log("DOM Carregado. Iniciando main38.js..."); // Updated version in log
    ...
    console.log("main38.js inicialização completa."); // Updated version in log
});
// === END INITIALIZATION ===

// === MANUAL UPDATE ===
// A função updateManualText() foi removida de main38.js pois as atualizações
// do manual para a v38 foram feitas diretamente no arquivo index38.html.
// Manter a função aqui seria redundante e potencialmente confuso.
            <hr>
        `;
