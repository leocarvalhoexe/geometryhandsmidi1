// ==========================================================================
// MIDI SHAPE MANIPULATOR v35 - main35.js
// ==========================================================================
...
function setupEventListeners() {
    ...
    // OSC Config Modal Listeners (v35)
    if (oscConfigButton) oscConfigButton.addEventListener('click', () => {
        if(oscConfigModal) {
    ...
    if (closeOscConfigModalButton) closeOscConfigModalButton.addEventListener('click', () => {if(oscConfigModal) oscConfigModal.style.display = 'none'});
    if (saveOscConfigButton) saveOscConfigButton.addEventListener('click', () => {
    ...
    if (reconnectOSCButton) reconnectOSCButton.addEventListener('click', () => {
        ...
        // loadOscSettings(); // Ensure OSC_HOST and OSC_PORT are up-to-date from localStorage
        setupOSC(); // Attempt to connect
        // Re-enable button after a timeout if connection still fails
        setTimeout(() => {
...
window.addEventListener('DOMContentLoaded', () => {
    console.log("DOM Carregado. Iniciando main35.js...");
    ...
    console.log("main35.js inicialização completa.");
});
// === END INITIALIZATION ===
