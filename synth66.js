// ==========================================================================
// SYNTHESIZER MODULE v66 - synth66.js
// ==========================================================================

// audioCtx e simpleSynth são agora gerenciados em main66.js
// _internalAudioEnabledMaster também é gerenciado em main66.js

const VALID_WAVEFORMS_V66 = ['sine', 'square', 'sawtooth', 'triangle', 'noise', 'pulse'];
...
class SimpleSynth {
  constructor(audioContext) {
    ...
    console.log("SimpleSynth v66 inicializado.");
  }
  ...
  setWaveform(newWaveform) {
    if (VALID_WAVEFORMS_V66.includes(newWaveform)) {
  ...
  allNotesOff() {
    console.log("SimpleSynth v66 All Notes Off (ADSR aware)");
    const now = this.audioCtx.currentTime;
...
console.log("synth66.js carregado e pronto para ser instanciado por main66.js.");
