// ==========================================================================
// SYNTHESIZER MODULE v71 - synth71.js
// ==========================================================================

// audioCtx e simpleSynth são agora gerenciados em main71.js
// _internalAudioEnabledMaster também é gerenciado em main71.js

const VALID_WAVEFORMS_V71 = ['sine', 'square', 'sawtooth', 'triangle', 'noise', 'pulse']; // Updated version
...
class SimpleSynth {
  constructor(audioContext) {
    ...
    console.log("SimpleSynth v71 inicializado."); // Updated version
  }
  ...
  setWaveform(newWaveform) {
    if (VALID_WAVEFORMS_V71.includes(newWaveform)) { // Updated version
  ...
  _playNote(midiNote, velocity) {
    ...
    if (this.oscillators[midiNote]) {
        ...
        } catch (e) { console.warn("Erro ao limpar oscilador/gain anterior em _playNote:", e); }
    ...
    if (this.waveform === 'noise') {
        ...
        if (!this.noiseBuffer) { console.error("Buffer de ruído não pôde ser criado. Impossível tocar nota de ruído."); return; }
        ...
        } catch (e) { console.warn("Falha ao criar PeriodicWave para 'pulse', usando 'square' como fallback.", e); osc.type = 'square'; }
  ...
  noteOff(midiNote) {
    ...
    if (this.oscillators[midiNote]) {
      ...
      if (gainNode && gainNode.numberOfOutputs > 0) {
          ...
          catch (e) { console.warn("Erro ao parar oscilador (pode já ter sido parado) em noteOff:", e); }
          setTimeout(() => {
  ...
  allNotesOff() {
    console.log("SimpleSynth v71 All Notes Off (ADSR aware)"); // Updated version
    const now = this.audioCtx.currentTime;
...
console.log("synth71.js carregado e pronto para ser instanciado por main71.js."); // Updated version
