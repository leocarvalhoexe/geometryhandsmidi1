// ==========================================================================
// MIDI SHAPE MANIPULATOR v55 - main55.js
// ==========================================================================
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  console.log("DOM Carregado. Iniciando main55.js (v55)..."); // Log de versão atualizado
    detectPlatform();
  ...
  if (oscLogTextarea) oscLogTextarea.value = `Log OSC - ${new Date().toLocaleTimeString()} - Configs Carregadas (v55).\n`;

  console.log("Iniciando loop de animação (v55) e finalizando DOMContentLoaded.");
    animationLoop();
});
