// ==========================================================================
// MIDI SHAPE MANIPULATOR v52 - main52.js
// ==========================================================================

// simpleSynth e audioCtx são gerenciados e obtidos de synth52.js
...
let shapePresets = {};
const APP_SETTINGS_KEY = 'midiShapeManipulatorV52Settings';
...
function saveAllPersistentSettings(){
  ...
  console.log("Configs V52 salvas no localStorage."); // V52 update
}
...
function loadAllPersistentSettings(){
  ...
  console.log("Configs V52 carregadas do localStorage."); // V52 update
  return {
...
function loadArpeggioSettings(){
    ...
    // if(scBPMSlider) scBPMSlider.value = arpeggioBPM; // V52
    // if(scBPMValueSpan) scBPMValueSpan.textContent = arpeggioBPM; // V52
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    const firstGestureHandler = () => {
        console.log("Primeiro gesto detectado, tentando inicializar o áudio via synth52.js..."); // V52 update
        if (typeof initAudioContextOnGesture === "function") {
            ...
            if (audioReady) {
                ...
                if (synthAfterGesture) {
                    ...
                    console.log("Áudio inicializado/resumido por gesto e synth (incluindo ADSR e Distorção) configurado com valores carregados.");
                } else {
                ...
                console.warn("initAudioContextOnGesture() de synth52.js não retornou sucesso. O áudio pode não estar pronto."); // V52 update
            }
        } else {
            console.error("initAudioContextOnGesture não está definida globalmente (esperada de synth52.js)."); // V52 update
        }
    };
  ...
  if (oscLogTextarea) oscLogTextarea.value = `Log OSC - ${new Date().toLocaleTimeString()} - Configs Carregadas (v52).\n`; // V52 update

  console.log("Iniciando loop de animação (v52) e finalizando DOMContentLoaded."); // V52 update
    animationLoop();
});
